...
АО «ВНОГ» предлагает воспользоваться простым и быстрым доступом к функциям нашей системы, которые включают в себя получение данных о грузе, отслеживание статуса доставки.
...
### [ Получение информации (GET)](#Содержание)<span id="ShippingGet"><span>

### Общие сведения
Метод отслеживания статуса доставки предоставляет возможность Клиентам АО «ВНОГ» получать актуальные сведения о статусе всех своих перевозок в режиме реального времени.
...
ИЛИ
| vehicle_number| Номер транспортного средства (ТС) | `Строка (100)` |
