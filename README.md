...
• Получать подробную информацию о вашем грузе.
• Получать статус доставки. Информация предоставляется как по номеру вашего заказа, по номеру транспортного средства, так и по комбинации реквизитов "Договор поставки" + "Номер приложения".
